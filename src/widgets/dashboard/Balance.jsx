      ...
      <div className="w-full">
            ...
            <SwiperSlide key={card.id}>
              ...
              {!isSettingsOpen && !isContactsOpen && !showAll && (
                <>
                  ...
                  <div className="text-center mb-[50px] [@media(min-height:860px)]:mb-[115px] flex justify-center items-center gap-2">
                    <img
                      src={plus}
                      alt="plus"
        ...
        {!isSettingsOpen && !isContactsOpen && !showAll && (
          <>
            {cards.length === 1 ? (
              <div
                className="flex absolute top-[376px] [@media(min-height:860px)]:top-[439px] right-1/2 z-[100] w-[120px] bg-[var(--bg-black-transparent)] rounded-full justify-center items-center gap-2 transform translate-x-1/2 transition-opacity duration-300"
                style={{
                  opacity:
              ...
              <button
                className="flex absolute top-[376px] [@media(min-height:860px)]:top-[439px]  left-1/2 z-[100] transform -translate-x-1/2 items-center mx-auto px-4 gap-2 py-[4px] rounded-full opacity-90 transition-opacity duration-300"
                style={{
                  opacity:
                    offsetY > 10 ? Math.max(1 - (offsetY - 10) / 40, 0) : 1,
